      ...
      <aside className="fixed left-0 top-0 h-screen w-64 bg-white shadow-lg hidden lg:block">
        ...
        <nav className="mt-6">
          <div className="px-4 space-y-2">
            <Link to="/dashboard" className="flex items-center space-x-3 p-3 rounded-lg bg-emerald-50 text-emerald-600">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-gray-900">8,647</h3>
                </div>
                <div className="w-12 h-12 bg-emerald-100 rounded-full flex items-center justify-center">
                  <i className="fas fa-shoe-prints text-emerald-600 text-xl"></i>
                </div>
              </div>
              <div className="mt-4">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-gray-900">486</h3>
                </div>
                <div className="w-12 h-12 bg-emerald-100 rounded-full flex items-center justify-center">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-gray-900">1.8L</h3>
                </div>
                <div className="w-12 h-12 bg-emerald-100 rounded-full flex items-center justify-center">
                  <i className="fas fa-glass-water text-emerald-600 text-xl"></i>
                </div>
              </div>
              <div className="mt-4">
                <div className="flex items-center text-sm">
                  <span className="text-gray-500">75% of daily goal</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="h-64 flex items-center justify-center">
                ...
                <div className="text-gray-400">Activity Chart Here</div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <div className="flex justify-between text-sm mb-2">
                    <span className="text-gray-600">Workout Goal</span>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center p-4 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    <h4 className="font-medium">Completed Workout</h4>
                    <p className="text-sm text-gray-500">Upper Body · 45 mins</p>
                  </div>
                ...
                <div className="flex items-center p-4 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    <h4 className="font-medium">Logged Meal</h4>
                    <p className="text-sm text-gray-500">Lunch · 650 cal</p>
                  </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center p-4 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Friday · 2:30 PM</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-4 sm:space-y-6">
            <div>
              ...
              <div className="space-y-2">
                <button className="w-full flex items-center space-x-3 p-2 sm:p-3 rounded-lg hover:bg-gray-50">
